...
<head>
    ...
    <script>
        $(document).on('click', '[id^="deleteButton"]', function(){
            ...
            var mother_id = $(this).data('mother-id');
            ...
            <div style="width: 95%; margin: 5px auto; ">
                ...
                <c:forEach var="helper" items="${helperInfo}" varStatus="status">
                    ...
                    <div style="display: flex; align-items: center; border: 3px solid #FE78A1; max-width: 100%; border-radius: 15px; margin: 10px auto; padding: 10px;">
                        ...
                        <div>
                            <input data-helper-id="${helper.helper_id}" type="hidden" name="helper_id${status.index}" value="${helper.helper_id}">
                            <input data-mother-id="<%=mother_id%>" type="hidden" name="mother_id${status.index}" value="<%=mother_id%>">
                            ...
                            <button id="deleteButton${status.index}" data-helper-id="${helper.helper_id}" data-mother-id="<%=mother_id%>" style="border-radius: 20px; color: white; background: red; font-weight: bold; font-size: 23px;padding: 4px 15px; border: none;">삭제</button>
