...
<%@ page import="com.example.sanpa_com.biz.mother.MotherVO" %>
...
<div class="mainFrame" style="position:relative; width: 480px; height: 1030px; background:white; display: inline-block; box-shadow: 0 0px 4px 4px lightgrey;">
    ...
    <div style="width:480px; height: 830px; position: absolute; background: white; top:100px;">
        ...
        <div style="width: 84%; border: 5px solid #FFB3B3; margin: 35px auto; background: #FF578B; border-radius: 25px;">
            ...
            <p STYLE="color: white;"><span style="font-weight: bold; font-size: 45px;margin-right: 10px;">B</span><span style="font-size: 25px; font-weight: bold">LEVEL</span></p>
            ...
            <div style="display: flex; justify-content: space-evenly; ">
                ...
                <div onclick="location.href='release_B_status'" style="width: 37%; border-radius: 20px; background: white; padding: 13px; display: inline-block; margin-bottom: 15px;">
        ...
        <div>
            <p style="color: #FF578B; font-weight: 600; font-size: 27px;">헬퍼즈 ${mother2}명 + 119 출동</p>
        </div>
